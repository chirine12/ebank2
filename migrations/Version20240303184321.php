 ...
 */
final class Version20240303184321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE assurance (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, delais VARCHAR(255) NOT NULL, montant INT NOT NULL, INDEX IDX_386829AE19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE beneficiaire (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, rib BIGINT NOT NULL, INDEX IDX_B140D80219EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cheque (id INT AUTO_INCREMENT NOT NULL, num BIGINT NOT NULL, numcompte BIGINT NOT NULL, montant DOUBLE PRECISION NOT NULL, signature VARCHAR(255) NOT NULL, date DATE NOT NULL, signature_id VARCHAR(255) DEFAULT NULL, document_id VARCHAR(255) DEFAULT NULL, signer_id VARCHAR(255) DEFAULT NULL, pdf_sans_signature VARCHAR(255) DEFAULT NULL, mail VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE compteep (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, typetaux_id INT DEFAULT NULL, rib BIGINT NOT NULL, solde DOUBLE PRECISION NOT NULL, type VARCHAR(255) NOT NULL, dateouv DATE NOT NULL, description VARCHAR(255) NOT NULL, etat TINYINT(1) DEFAULT NULL, INDEX IDX_E9CE68A819EB6921 (client_id), INDEX IDX_E9CE68A89ABE80EC (typetaux_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE contrat (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, datedeb DATE NOT NULL, datefin DATE NOT NULL, signature_file VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, phone_number INT NOT NULL, INDEX IDX_6034999319EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE credit (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, typecredit_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, montant DOUBLE PRECISION NOT NULL, payement DOUBLE PRECISION NOT NULL, duree INT NOT NULL, datedeb DATE NOT NULL, datefin DATE NOT NULL, INDEX IDX_1CC16EFE19EB6921 (client_id), INDEX IDX_1CC16EFE2D394D65 (typecredit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE invest (id INT AUTO_INCREMENT NOT NULL, idclient INT DEFAULT NULL, crypto VARCHAR(255) DEFAULT NULL, action VARCHAR(255) DEFAULT NULL, amount INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE virement (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, source BIGINT NOT NULL, destinataire BIGINT NOT NULL, motif VARCHAR(255) NOT NULL, montant DOUBLE PRECISION NOT NULL, date DATE DEFAULT NULL, INDEX IDX_2D4DCFA619EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE assurance ADD CONSTRAINT FK_386829AE19EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
        $this->addSql('ALTER TABLE beneficiaire ADD CONSTRAINT FK_B140D80219EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
        ...
        $this->addSql('ALTER TABLE compteep ADD CONSTRAINT FK_E9CE68A89ABE80EC FOREIGN KEY (typetaux_id) REFERENCES typetaux (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE compteep DROP FOREIGN KEY FK_E9CE68A89ABE80EC');
