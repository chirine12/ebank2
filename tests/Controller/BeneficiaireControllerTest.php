...
class BeneficiaireControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'beneficiaire[nom]' => 'Testing',
            'beneficiaire[prenom]' => 'Testing',
            'beneficiaire[Rib]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'beneficiaire[nom]' => 'Something New',
            'beneficiaire[prenom]' => 'Something New',
            'beneficiaire[Rib]' => 'Something New',
        ]);
